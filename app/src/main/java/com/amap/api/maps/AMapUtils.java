...
public class AMapUtils {
    ...
    static class a extends Thread {
        ...
        public final void run() {
            if (this.b != null) {
                try {
                    Cif.a(this.b, new im.a(this.a, "5.4.0", g.d).a(new String[]{"com.amap.api.maps"}).a());
                    interrupt();
                } catch (ic e) {
                    e.printStackTrace();
                }
    ...
    public static float calculateLineDistance(LatLng latLng, LatLng latLng2) {
        ...
        if (latLng3 == null || latLng4 == null) {
            ...
            try {
                ...
                double[] dArr2 = {cos3 * cos4, cos4 * d7, sin4};
    ...
    public static void openAMapNavi(NaviPara naviPara, Context context) throws AMapException {
        if (!a(context)) {
            ...
            try {
                ...
                intent.addFlags(276824064);
                intent.addCategory("android.intent.category.DEFAULT");
                intent.setData(Uri.parse(String.format(Locale.US, "androidamap://navi?sourceApplication=%s&lat=%f&lon=%f&dev=0&style=%d", new Object[]{id.b(context), Double.valueOf(naviPara.getTargetPoint().latitude), Double.valueOf(naviPara.getTargetPoint().longitude), Integer.valueOf(naviPara.getNaviStyle())})));
    ...
    public static void openAMapPoiNearbySearch(PoiPara poiPara, Context context) throws AMapException {
        if (!a(context)) {
            ...
            try {
                ...
                intent.addFlags(276824064);
                intent.addCategory("android.intent.category.DEFAULT");
                String format = String.format(Locale.US, "androidamap://arroundpoi?sourceApplication=%s&keywords=%s&dev=0", new Object[]{id.b(context), poiPara.getKeywords()});
