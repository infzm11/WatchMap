...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    static /* synthetic */ void a(SwipeDismissTouchListener swipeDismissTouchListener) {
        ...
        ValueAnimator duration = ValueAnimator.ofInt(new int[]{height, 1}).setDuration(swipeDismissTouchListener.d);
            ...
            case 1:
                if (this.m != null) {
                    ...
                    if (z) {
                        ...
                        this.e.animate().translationX(0.0f).alpha(1.0f).setDuration(this.d).setListener((Animator.AnimatorListener) null);
                    }
                    this.m.recycle();
                    this.m = null;
                    this.n = 0.0f;
