...
public final class kb implements Closeable {
    ...
    private kb(InputStream inputStream, Charset charset, byte b2) {
        ...
        synchronized (this.a) {
            ...
            AnonymousClass1 r1 = new ByteArrayOutputStream((this.e - this.d) + 80) {
                public final String toString() {
                    try {
                        return new String(this.buf, 0, (this.count <= 0 || this.buf[this.count + -1] != 13) ? this.count : this.count - 1, kb.this.b.name());
