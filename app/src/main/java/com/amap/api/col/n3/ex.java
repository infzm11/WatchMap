...
public final class ex implements IFrameForWTBT {
    private NaviInfo a;
    private int b;
    private fi c;
    private Context d;
    ...
    public ex(Context context, fi fiVar) {
        try {
            this.c = fiVar;
            this.d = context;
            this.e = fiVar.o();
    ...
    public final void requestHttp(int i, int i2, int i3, String str, String str2, byte[] bArr, int i4) {
        try {
            ...
            if (this.c != null) {
                fn fnVar = new fn(this.c, this.d, str3, i3, str2, i, i2, bArr);
                ks.a(2).a((kt) fnVar);
            }
        } catch (Throwable th) {
            Throwable th2 = th;
    ...
    public final void setRouteRequestState(int i) {
        ...
        if (i == 1) {
            try {
                ...
                fk.a("http://restapi.amap.com/v3/direction/walking".replace("http://restapi.amap.com/", ""), i);
            } catch (Throwable th) {
                th.printStackTrace();
                hq.a(th);
            ...
            if (this.e != null) {
                ...
                fk.a("http://restapi.amap.com/v3/direction/walking".replace("http://restapi.amap.com/", ""), i2);
            }
        }
    }
