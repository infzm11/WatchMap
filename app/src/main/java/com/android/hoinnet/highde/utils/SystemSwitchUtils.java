...
public class SystemSwitchUtils {
    ...
    public void wifiUtils() {
        if (isWifiOn()) {
            ((WifiManager) Utils.getContext().getSystemService("wifi")).setWifiEnabled(false);
        } else {
            ((WifiManager) Utils.getContext().getSystemService("wifi")).setWifiEnabled(true);
        }
    }
    ...
    public boolean isSyncSwitchOn() {
        return ((ConnectivityManager) Utils.getContext().getSystemService("connectivity")).getBackgroundDataSetting() && ContentResolver.getMasterSyncAutomatically();
    }
    ...
    public static boolean isRingerModeSilent() {
        return ((AudioManager) Utils.getContext().getSystemService("audio")).getRingerMode() == 0;
    }
    ...
    public static void rebootUtils() {
        ((PowerManager) Utils.getContext().getSystemService("power")).reboot((String) null);
    }
