...
public class cs {
    ...
    private static Drawable c(Context context, String str) throws Exception {
        InputStream b2 = b(context, e + str + ".png");
        TypedValue typedValue = new TypedValue();
        typedValue.density = 240;
        Drawable a2 = Build.VERSION.SDK_INT > a ? ct.a(context.getResources(), typedValue, b2, str, (BitmapFactory.Options) null) : Drawable.createFromResourceStream(context.getResources(), typedValue, b2, str);
        if (b2 != null) {
            b2.close();
        }
        return a2;
