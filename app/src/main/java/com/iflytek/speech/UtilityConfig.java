...
public class UtilityConfig {
    ...
    public static String getComponentUrlParam(Context context) {
        ...
        String str = "os.imei=" + bp.a(context).e("os.imei");
        String str2 = str + ";net.mac=" + bp.a(context).e("net.mac");
        appendHttpParam(stringBuffer, KEY_DEVICE_INFO, new String(bu.a((str2 + ";unique_id=" + ca.a(context)).getBytes())));
